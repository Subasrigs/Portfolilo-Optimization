...
class DDPGAgent:
    ...
    def __init__(self, state_dim, action_dim, action_high):
        ...
        self.critic_optimizer = optim.Adam(self.critic.parameters(), lr=DDPG_CONFIG['critic_lr'])

        self.action_high = action_high
        self.noise_sigma = DDPG_CONFIG['noise_sigma_start']
    ...
    def select_action(self, state, training=True):
        ...
        if training:
            ...
            self.noise_sigma = max(
                DDPG_CONFIG['noise_sigma_min'],
                self.noise_sigma * DDPG_CONFIG['noise_decay_rate']
            )
